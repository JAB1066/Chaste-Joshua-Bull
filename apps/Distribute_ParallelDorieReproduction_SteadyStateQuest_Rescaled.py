...
executable = '/mi/share/scratch/bull/ChasteStuff/chaste-release/projects/JoshuaBull/apps/Exe_ParallelDorieReproduction_SteadyStateQuestRescaled'

chaste_test_dir = os.environ.get('CHASTE_TEST_OUTPUT')
path_to_output = os.path.join(chaste_test_dir,'ParameterSweeps','DorieReproduction_SteadyStateQuestRescaled')
...
it = np.linspace(1, 12, num=12)
accl = np.linspace(24.0, 24.0, num=1)
hc = np.linspace(0.3, 0.3, num=1)
qc = np.linspace(0.3, 0.9, num=13)
chd = np.linspace(0.0, 0.0, num=1)
