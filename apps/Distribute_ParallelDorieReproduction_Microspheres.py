...
path_to_output = os.path.join(chaste_test_dir,'ParameterSweeps','DorieReproduction','6thJan_FullSimulations','Wolverine')
...
it = np.linspace(1, 24, num=24)
accl = np.linspace(16, 16, num=1)
hc = np.linspace(0.3, 0.3, num=1)
qc = np.linspace(0.3, 0.4, num=2)
chd = np.linspace(16.0, 16.0, num=1)
